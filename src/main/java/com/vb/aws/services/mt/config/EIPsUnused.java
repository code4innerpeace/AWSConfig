...
import com.vb.aws.services.compute.ec2.EC2Utils;
 ...
 */
public class EIPsUnused {
    
    private static final String MESSAGE_TYPE_PROPERTY = "messageType";
    private static final String COMPLIANCE_RESOURCE_TYPE = "AWS::EC2::EIP";
    ...
    public void doHandle(ConfigEvent event,Context context, AmazonConfig awsConfig, EC2UtilsImpl ec2UtilsImpl) throws IOException {
        ...
        // Fetch all EIPs
        List<Address> allEIPs = ec2UtilsImpl.getAllEIPs();
        
        // Fetch all Unused EIPs
        List<Address> allUnusedEIPs = ec2UtilsImpl.getAllUnusedEIPs(allEIPs);
        
        
        List<Evaluation> evaluations = createEvaluations(allUnusedEIPs);
