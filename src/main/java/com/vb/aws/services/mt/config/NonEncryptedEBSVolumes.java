 ...
 */
public class NonEncryptedEBSVolumes {
    ...
    public void doHandle(ConfigEvent event,Context context, AmazonConfig awsConfig, EC2UtilsImpl ec2UtilsImpl) throws IOException {
        ...
        // Fetch all non encrypted volumes.
        List<Volume> allNonEncryptedEBSVolumes = ec2UtilsImpl.getAllNonEncryptedEBSVolumes(allEBSVolumes);
        
        // Fetch all encrypted volumes.
        
        List<Evaluation> evaluations = createEvaluations(allNonEncryptedEBSVolumes);
